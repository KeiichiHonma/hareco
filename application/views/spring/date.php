...
<div id="mainImage" class="sub main">
    <div id="mainImageInner">
        ...
        <div id="copy">
            <div id="innerBox">
                <h2><span><?php echo $springs[0]->spring_name; ?> <?php echo $display_date; ?></span></h2>
...
-->
        ...
        <div id="guide2">
            <h2><?php echo $springs[0]->spring_name.'-'.date("n月j日",$from_datetime); ?>ヒストリー</h2>
            <div class="line cf">
        ...
        <div id="backnumber">
            <h2><?php echo $springs[0]->spring_name.'-'.date("n月j日",$from_datetime); ?>の過去データ</h2>
            <table>
