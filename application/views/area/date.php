...
<fieldset class="fieldset">
  <input id="demo001"  type="text" placeholder="クリックしてください">
    ...
    <h2><?php echo $areas[$area_id]->area_name.'-'.$week_futures[0]->date; ?>の天気予想</h2>
    <table>
        <tr>
    ...
    <h2><?php echo $areas[$area_id]->area_name.'-'.$week_futures[0]->date; ?>の記録データ</h2>
    <table border=1>
...
<div id='calendar'></div>
    ...
    <h2><?php echo $areas[$area_id]->area_name.'-'.$week_futures[0]->date; ?>の過去データ</h2>
    <table class="data2_s">
    ...
    <h2><?php echo $areas[$area_id]->area_name; ?>晴れの休日</h2>
    ...
    <?php if(!empty($springs)) : ?>
        <?php if( !empty($s_area_plans) ) : ?>
            <h2>[晴れ予想の<?php echo $week_futures[0]->date; ?>に<?php echo $areas[$area_id]->area_name; ?>近辺の温泉プラン]</h2>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <h2>[晴れ予想の<?php echo $week_futures[0]->date; ?>に<?php echo $springs[0]->spring_area_name.'-'.$areas[$area_id]->area_name; ?>近辺の温泉プラン]</h2>
