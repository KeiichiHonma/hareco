...
<div id="mainImage" class="sub main">
    <div id="mainImageInner">
        ...
        <div id="copy">
            <div id="innerBox">
                <h2><?php echo $areas[$area_id]->area_name; ?>エリア <?php echo $display_date; ?></h2>
...
-->
        ...
        <div id="guide2">
            <h2><?php echo $areas[$area_id]->area_name.'-'.date("n月j日",$from_datetime); ?>ヒストリー</h2>
            <div class="line cf">
...
<?php //エリアなので複数の温泉地が来る可能性がある ?>
    ...
    <?php endif; ?>
        ...
        <div id="recommend">
            <h2><?php echo $areas[$area_id]->area_name; ?>の休日プラン</h2>
        ...
        <div id="backnumber">
            <h2><?php echo $areas[$area_id]->area_name.'-'.date("n月j日",$from_datetime); ?>の過去データ</h2>
            <table>
