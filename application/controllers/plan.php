...
class Spring extends MY_Controller {
    ...
    function show($spring_id)
    {
        ...
        //jalan data
        $data['hotels'] = $this->jalan_lib->getHotelsBySpringIdByOarea($spring->jalan_o_area);
        ...
        $data['holiday_futures'] = $this->Future_model->getFuturesByAreaIdByHolidayBySequence($spring->area_id,$holiday,$sequence,$orderExpression, $page);
        ...
        $data['header_description'] = sprintf($this->lang->line('spring_header_description'), $spring->spring_name, $this->config->item('website_name', 'tank_auth'), implode('/',$categories_name_array));
